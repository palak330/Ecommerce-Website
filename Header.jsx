...
import { ShopContext } from "../Context/ShopContext";// Header.jsx
//import { getTotalCartItems } from './path/to/cartUtils';
...
const Header = () => {
  ...
  const {getTotalCartItems}=useContext(ShopContext);
    ...
    <header className="fixed top-0 left-0 m-auto max_padd_container w-full
     bg-white ring-1 ring-slate-900/5 z-10">
       ...
       <div className="flexBetween sm:gap-x-2 bold-16">
        {!menuOpened? (
          ...
          <div className="flexBetween sm:gap-x-6">
            ...
            rounded-full"/><span className="relative flexCenter w-5 h-5 rounded-full
            bg-secondary text-white medium-14 -top-2">{getTotalCartItems()}</span></NavLink>
            {/* <NavLink to={'logout'} className={"btn_secondary_rounded flexCenetr gap-x-2 medium-16"}>
