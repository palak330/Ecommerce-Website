  ...
  return (
    <section className='relative bg-hero bg-cover bg-center bg-no-repeat h-screen w-full'>
        <div className='max_padd_container relative top-32 xs:top-52'>
            ...
            <p className='text-gray-50 regular-16 mt-6 max-w-[33rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit.laudantium poluptatibus similique, rro nam voerror ab dolorum ad maxime.</p>
            <div className='flexStart !items-center gap-x-4 my-10'>
                ...
                className='regular-16 sm:regular-20'>Excellent Reviews</span></div>
            </div>
